...
void RigidMesh::SetVertexBuffers(ID3D12GraphicsCommandList* commandList, UINT startSlot) {
	//頂点バッファビューの設定
	commandList->IASetVertexBuffers(startSlot, 1, &vertexBufferView_);
}

void RigidMesh::InitializeVertexResourceSphere(ID3D12Device* device) {
...
void RigidMesh::InitializeVertexResourceSprite(ID3D12Device* device, Vector2 anchorPoint) {
...
void RigidMesh::InitializeVertexResourceTriangle(ID3D12Device* device) {
...
void RigidMesh::InitializeVertexResourceModel(ID3D12Device* device, ModelData modelData) {
...
void RigidMesh::InitializeIndexResourceSphere(ID3D12Device* device) {
...
void RigidMesh::InitializeIndexResourceSprite(ID3D12Device* device) {
...
void RigidMesh::InitializeIndexResourceModel(ID3D12Device* device, ModelData modelData) {
