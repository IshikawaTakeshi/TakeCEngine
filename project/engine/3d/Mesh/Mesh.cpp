...
// メッシュ初期化
//=============================================================================
void Mesh::InitializeMesh(DirectXCommon* dxCommon,std::vector<ModelMaterialData> materialData) {
...
void Mesh::InitializeMesh(DirectXCommon* dxCommon, const std::string& texturePath, const std::string& envMapPath) {
