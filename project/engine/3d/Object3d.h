...
namespace TakeC {
	...
	//============================================================================
	/// <summary>
	/// ワールド変換とモデルを保持し、3Dオブジェクトを更新・描画するクラスです。
	/// </summary>
	class Object3d {
	public:
	...
	public: 
		...
		//モデルの取得
		TakeC::Model* GetModel() { return model_.get(); }
		const TakeC::Model* GetModel() const { return model_.get(); }
	...
	protected: // privateメンバ変数
		...
		//モデル
		std::shared_ptr<TakeC::Model> model_;
		//モデルファイルパス
