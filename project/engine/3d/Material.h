...
namespace TakeC {
	...
	public:
		...
		const TakeC::MaterialData* GetMaterialData() const { return materialData_; }
		// テクスチャファイルパスの取得
		...
		// materialDataの設定
		void SetMaterialData(TakeC::MaterialData* materialData) { materialData_ = materialData; }
		// ライティング有効フラグの設定
	...
	private:
		...
		TakeC::MaterialData* materialData_ = nullptr;
