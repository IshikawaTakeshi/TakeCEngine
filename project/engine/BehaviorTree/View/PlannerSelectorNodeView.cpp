#include "PlannerSelectorNodeView.h"

//====================================================================
// コンストラクタ
//====================================================================
PlannerSelectorNodeView::PlannerSelectorNodeView() {
...
// ノードの内容描画
//====================================================================
void PlannerSelectorNodeView::draw() {
	...
	if (ImGui::Button("Add Child")) {
		std::string name = std::to_string(childCount_);
