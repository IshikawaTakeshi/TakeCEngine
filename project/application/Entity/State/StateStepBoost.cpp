...
//　コンストラクタ
//===================================================================================
StateStepBoost::StateStepBoost(baseInputProvider* provider) {
...
//　初期化
//===================================================================================
void StateStepBoost::Initialize(PlayableCharacterInfo& characterInfo) {
...
//　更新
//===================================================================================
void StateStepBoost::Update(PlayableCharacterInfo& characterInfo) {
