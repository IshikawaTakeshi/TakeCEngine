...
// 初期化
//===================================================================================
void BulletCounterGaugeUI::Initialize(TakeC::SpriteManager* spriteManager, BaseWeapon* currentWeapon) {
	// BaseUIの初期化
	...
	std::string fullPath_Frame = "BulletCounterGauge_Frame_" + StringUtility::EnumToString(weaponUnit) + ".json";
	std::string fullPath_Bar = "BulletCounterGauge_Bar_" + StringUtility::EnumToString(weaponUnit) + ".json";
